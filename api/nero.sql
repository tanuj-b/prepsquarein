...
# Database: edu
# Generation Time: 2012-10-11 05:01:36 +0530
# ************************************************************
...
VALUES
	...
	(31,'Two poles of height \'a\' and \'b\' units respectively are \'c\' units apart on a plane surface. The height \'h\' of the point of intersection of the lines joining the top of each pole to the foot of opposite poles is  - ','AM of the 2 poles|:GM of the 2 poles|:HM/2 of the 2 poles|: None of the above|:Cannot be determined',0,NULL,10,4,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	(32,'There are 10 children standing in line with each having a certain number of candies. If the first child distributes the candies to the remaining nine such that he doubles their candies, he will be left with just one candy. If the tenth child takes away one candy from each of the remaining nine then he will have eight candies less than the number of candies that the first child initially had. What is the number of candies held  by 8th child if child 2 to 9 held the same number of candies','1|:2|:3|:4|:Cannot be determined',1,NULL,14,4,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	(33,'Six years ago, the age of a person was two years more than five times the age of his son. Four years hence, his age will be two years less than three times the age of his son. After how many years from now will their combined age be 100 years.','24 years|:19 years|:14 years|:25 years|:Cannot be determined',2,NULL,14,4,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	(34,'A fraction becomes half if the numerator is increased by 1 and the denominator by 3. It becomes 2/5 if the numerator is increased by 2 and the denominator by 7. Find the fraction:','1/2|:4/7|:1/5|:2/3|:None of the above',2,NULL,14,4,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
VALUES
	(1,'33|:6|:8|:31|:11|:15|:16|:18|:32|:10',1,NULL,NULL,NULL,10,100),
...
CREATE TABLE `results` (
  ...
  CONSTRAINT `results_ibfk_1` FOREIGN KEY (`quiz_id`) REFERENCES `quizzes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `results_ibfk_2` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
